...
var person = {
        name: 'iNex',
        avatar: '/static/img/bots/bot-icon.svg'
    }
...
$$('.messagebar textarea').on("keydown", function(e) {
    ...
    if (e.keyCode == 13) {
            ...
            setTimeout(function() {document.getElementById("msg").placeholder=""},5000);
            }
...
$$('#speech').on('click', function() {
    ...
    if(!$('#mic').hasClass('fa-microphone-slash')){   //If not disabled then show Speech : On
...
if(isVisible){
    ...
    answerTimeout = setTimeout(function () {
        ...
        answerText = $$.post( "/converse", data, function(response) {
                        ...
                        if(!$('#speech').hasClass('fa-volume-off')){ //If speaker button is not disabled then perform TTS
