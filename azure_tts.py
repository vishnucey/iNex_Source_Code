...
class TextToSpeech(object):
    ...
    def __init__(self, input_text):
        ...
        subscription_key= loaded_parameters['azure_tts']['subscription_key']
    ...
    def get_token(self):
        fetch_token_url = loaded_parameters['azure_tts']['fetch_token_url'] 
    ...
    def save_audio(self):
        base_url = loaded_parameters['azure_tts']['base_url'] 
        # base_url = 'https://northcentralus.tts.speech.microsoft.com/'
        path = loaded_parameters['azure_tts']['path']
